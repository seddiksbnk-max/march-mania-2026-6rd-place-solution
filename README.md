...
we leveraged 25 human-created brackets (Men’s tournament) as an additional external signal [espn bracket](https://fantasy.espn.com/games/tournament-challenge-bracket-2026/addata=tcmens2026_ncaam_web_quicklinks_ncaam)  :
```python
